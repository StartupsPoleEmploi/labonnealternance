...
export const computeLatitudeDiff = (latitude, distance) => distance * 1000 * M;

export const computeLongitudeDiff = (latitude, longitude, distance) => (distance * 1000 * M) / Math.cos(latitude * (Math.PI / 180));