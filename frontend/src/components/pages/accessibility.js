        ...
        return (
            <div className="max-size-1000">
                ...
                <main className="content">
										...
										<p>L'accessibilité du Web signifie que les personnes en situation de handicap peuvent utiliser le Web. Plus précisément, qu'elles peuvent percevoir, comprendre, naviguer et interagir avec le Web, et qu'elles peuvent contribuer sur le Web. L'accessibilité du Web bénéficie aussi à d'autres, notamment les personnes âgées dont les capacités changent avec l'âge. L'accessibilité du Web comprend tous les handicaps qui affectent l'accès au Web, ce qui inclut les handicaps visuels, auditifs, physiques, de paroles, cognitives et neurologiques</p>
										...
										<p>Le site <a href="https://labonnealternance.pole-emploi.fr/">La bonne alternance</a> est en cours d’optimisation afin de le rendre conforme au <a href="http://references.modernisation.gouv.fr/referentiel/" target="_blank">RGAA v3</a>. La déclaration de conformité sera publiée ultérieurement.</p>
