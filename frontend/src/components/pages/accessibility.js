        ...
        return (
            <div className="max-size-1000">
                ...
                <main className="content">
										...
										<p>Le site <a href="https://labonnealternance.pole-emploi.fr/">La bonne alternance</a> est en cours d’optimisation afin de le rendre conforme au <a href="http://references.modernisation.gouv.fr/referentiel/">RGAA v3</a>. La déclaration de conformité sera publiée ultérieurement.</p>
